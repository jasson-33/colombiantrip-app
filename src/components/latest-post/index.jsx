...
const LatestPost = () => {
  ...
  return <div className={styles.containerLatest}>
    <div className={styles.lastPost}>
        ...
        <div className={styles.infoLatestPost}>
            ...
            <h2 className={`${styles.titleLatestPost} ${Bigola.className}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do.</h2>
